import { PaymentFlowError, confirmInvoicePayment } from '../../../../server/services/invoicePayment.js'
...
export default async function handler(req: any, res: any) {
  ...
  try {
    const data = await confirmInvoicePayment(id, {
    ...
    console.error('[POST /api/contracts/:id/pay/confirm]', err)
