import { PaymentFlowError, startInvoicePayment } from '../../../../server/services/invoicePayment.js'
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const data = await startInvoicePayment(id, payerAddress)
    ...
    console.error('[POST /api/contracts/:id/pay/start]', err)
