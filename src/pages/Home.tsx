    ...
    <main className="min-h-[calc(100vh-134px)] max-w-6xl mx-auto px-6 py-8 flex flex-col justify-center gap-6">
      <section className="nyx-card p-6 md:p-7">
        ...
        <p className="text-nyx-muted text-sm md:text-base max-w-3xl leading-relaxed">
          Create invoices, share a payment link, and settle on-chain — without exposing pricing or relationships.
        </p>
        ...
        {/* tiny value line (Stripe/Wise vibe) */}
        <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-nyx-muted">
          <span className="inline-flex items-center gap-1.5">
            <ShieldCheck size={14} strokeWidth={1.8} /> Private settlement
          </span>
          <span className="inline-flex items-center gap-1.5">
            <CheckCircle2 size={14} strokeWidth={1.8} /> On-chain confirmation
          </span>
          <span className="inline-flex items-center gap-1.5">
            <FileText size={14} strokeWidth={1.8} /> Receipt-ready invoicing
          </span>
        </div>
      </section>
      ...
      <section>
        <div className="mb-4">
          ...
          <p className="text-nyx-muted text-sm mt-1">
            Create an invoice, share the link, and confirm payment — without leaking financial intel.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ServiceCard
            icon={FileText}
            title="Invoice & Share"
            description="Create an invoice with line items and generate a public payment link in seconds."
          />
          <ServiceCard
            icon={ShieldCheck}
            title="Public payment. Private settlement."
            description="Payers use MetaMask or card-style checkout. Settlement stays private, with verifiable confirmation."
          />
        </div>
      </section>
    </main>
