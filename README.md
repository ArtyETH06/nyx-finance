...
NYX is a private on-chain invoicing platform built on **Monad** using **Unlink’s privacy SDK** 🔐.

It allows freelancers to create invoices 🧾, share public payment links 🔗, and receive blockchain payments — without exposing their financial data.
